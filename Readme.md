...
# Parsing + Configuration Script – LHT65 - Rev. A

This **Parsing + Configuration** script is designed for the **LHT65** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – LHT65 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **LHT65** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
